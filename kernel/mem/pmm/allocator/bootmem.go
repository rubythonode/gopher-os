...
var (
	...
	errBootAllocUnsupportedPageSize = &kernel.Error{Module: "pmm/allocator/BootMem", Message: "allocator only support allocation requests of order(0)"}
	errBootAllocOutOfMemory         = &kernel.Error{Module: "pmm/allocator/BootMem", Message: "out of memory"}
)
